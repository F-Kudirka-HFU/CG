...
namespace Fusee.Tutorial.Core
{
    public class HierarchyInput : RenderCanvas
    {
        ...
        private TransformComponent _GripOneTransform;
        private TransformComponent _GripTwoTransform;
        
        private bool gO = false;
        
        private bool gOfinished = false;
        private bool gCfinished = false;
        ...
        SceneContainer CreateScene()
        {
            ...
            _foreArmTransform = new TransformComponent
            {
             ...
             _GripOneTransform = new TransformComponent
            {
                Rotation = new float3(0.8f, 0, 0),
                Scale = new float3(1, 1, 1),
                Translation = new float3(1, 10, 1)
            };

             _GripTwoTransform = new TransformComponent
            {
                Rotation = new float3(0.8f, 0, 0),
                Scale = new float3(1, 1, 1),
                Translation = new float3(-1, 10, 1)
                        ...
                        Children = new List<SceneNodeContainer>
                        {
                            ...
                            new SceneNodeContainer
                            {
                                ...
                                Children = new List<SceneNodeContainer>
                                {
                                        ...
                                        Children = new List<SceneNodeContainer>
                                        {
                                            new SceneNodeContainer
                                            {
                                                Components = new List<SceneComponentContainer>
                                                {
                                                    ...
                                                    new MaterialComponent
                                                    {
                                                        Diffuse = new MatChannelContainer { Color = new float3(0.4f, 0.4f, 0.4f) },
                                                        Specular = new SpecularChannelContainer { Color = new float3(1, 1, 1), Shininess = 5 }
                                                    },
                                                    SimpleMeshes.CreateCuboid(new float3(.5f, 3, .5f))
                                                }
                                            }
                                        }
                                    },
                                 ...
                                 } //Children Blue Forearm
                                    }, //Blue Forearm End
                        }//Greenforearm Child End
                    }
                }
            };
        }
        ...
        public void gClosing () {
             if (_GripOneTransform.Rotation.z < 0)
                {
                    gC = false;
                    gCfinished = true;
                }
                float gRotation = _GripOneTransform.Rotation.z;
                gRotation -= 0.025f * 100 * DeltaTime;
                _GripOneTransform.Rotation.z = gRotation;

                gRotation = _GripTwoTransform.Rotation.z;
                gRotation += 0.025f * 100 *  DeltaTime;
                _GripTwoTransform.Rotation.z = gRotation;
        }

        public void gOpening () {
            if (_GripOneTransform.Rotation.z > 0.5f)
                {
                    gO = false;
                    gOfinished = true;
                }
